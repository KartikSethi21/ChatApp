...
const allMessages=tryCatch(async(req,res)=>{
    ...
    const transformedMessages= message.map(({content,attachments,_id,sender,createdt,chat})=>({
        _id,
        attachments,
        content,
        chat:chat._id,
...
const getDashboardStats=tryCatch(async(req,res)=>{
    const [groupsCout,userCount,messagesCount,totalChatsCount]=await Promise.all([
